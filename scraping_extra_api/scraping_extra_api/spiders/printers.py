...
class PrintersSpider(scrapy.Spider):
	filters = { 'printers' : 'c56_c61' }
	page_products = 1

	name = 'printers'
	allowed_domains = ['www.extra.com.br', 'pdp-api.extra.com.br']
	start_urls = [f'http://www.extra.com.br/api/catalogo-ssr/products/?Filtro={filters["printers"]}&PaginaAtual={page_products}']
	...
	def parse(self, response):
		...
		if data['products']:
			...
			url_products = f'http://www.extra.com.br/api/catalogo-ssr/products/?Filtro={self.filters["printers"]}&PaginaAtual={self.page_products}'
