...
class TelevisionsSpider(scrapy.Spider):
	filters = { 'televisions' : 'c1_c2' }
	page_products = 1

	name = 'televisions'
	allowed_domains = ['www.extra.com.br', 'pdp-api.extra.com.br']
	start_urls = [f'http://www.extra.com.br/api/catalogo-ssr/products/?Filtro={filters["televisions"]}&PaginaAtual={page_products}']
	...
	def parse(self, response):
		...
		if data['products']:
			...
			url_products = f'http://www.extra.com.br/api/catalogo-ssr/products/?Filtro={self.filters["televisions"]}&PaginaAtual={self.page_products}'
